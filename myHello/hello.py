...
print('below test for iter to print yanghui')
print('tye yangHui is iterator ? ', isinstance(yangHui(5), Iterator))
for yanghuivalue in yangHui(5) : print(yanghuivalue)